...
<div class="panel panel-default">
  <div class="panel-body">
    <div class="well">
     ...
     @endif
    <form action='{{url("/job-board/single-job/{$job->slug}")}}' method="post">
      {{csrf_field()}}
      {{method_field('PUT')}}
      ...
      <div class="form-group{{ $errors->has('vacancy') ? ' has-error' : '' }}">
        ...
        <input id="vacancy" type="text" class="form-control" name="vacancy" value="{{ $job->vacancy }}" >
      ...
      <div class="form-group{{ $errors->has('experience') ? ' has-error' : '' }}">
        ...
        <input id="experience" type="text" class="form-control" name="experience" value="{{ $job->experience }}" >
      ...
      <div class="form-group{{ $errors->has('experience') ? ' has-error' : '' }}">
          ...
          <div class="input-group date" data-provide="datepicker">
            <input name="deadline" type="text" class="form-control" data-date-format="yyyy/mm/dd" value="{{$job->deadline}}">
      ...
      <div class="form-group">
          ...
          <textarea name="short_description" id="short_description" class="form-control">{{ $job->short_description }}</textarea>
      </div>
      ...
      <div class="form-group">
          ...
          <input value="{{ $job->keywordsInString() }}" type="text" name="keywords" class="form-control" id="keywords" placeholder="php, asp, management, programming">
      </div>
